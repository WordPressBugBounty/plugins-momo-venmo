...
echo wp_kses_post(WCVENMO_PLUGIN_SLUG);
?>" />
                <input type="hidden" name="key" id="key" />

                <?php
echo wp_kses_post(wp_nonce_field( 'connect_store_to_emailreceipts' ));
?>

                <input type="submit" value="<?php
echo wp_kses_post($connect_button_text);
?>" data-wait="Please wait..." class="btn btn-light btn-lg fs-5 py-2 px-4" />
            </form>

            <p class="mb-4"><?php
echo wp_kses_post($upgrade);
?></p>
        </div>
    </div>
</section>
